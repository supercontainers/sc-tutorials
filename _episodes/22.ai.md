...
1. Sign up for an OpenRouter account [here](https://openrouter.ai)
2. New users receive a small free allowance
3. Pick one of the free models listed [here](https://openrouter.ai/models?max_price=0), e.g. `google/gemma-4-31b-it:free`, `openai/gpt-oss-20b:free` or `nvidia/nemotron-3-super-120b-a12b:free`.
